/**
 * Class to represent a ship and it's data and values
 *
...
public class Ship {
    ...
    /**
     * constructor creates a ship object
     * @param nr number
     * @param name name
     */
    ...
    /**
     * calculates the random race time for this particular ship
     * @see #time
     */
    public void race() {
        int min = 300;
